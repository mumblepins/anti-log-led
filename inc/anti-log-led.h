...
namespace AntiLogLed {
    ...
    class RgbLed {
    private:
        bool _state, _inError, _inBlink, _currentOn;
        unsigned long _lastSwitch, _curDelay;
        ...
        bool _normalize;
        void updateLed(void);
        void updateColor(uint8_t red, uint8_t green, uint8_t blue);
        void updateBrightness(uint8_t bright);
    ...
    public:
        ...
        void colorAndBrightness(uint8_t red, uint8_t green, uint8_t blue, uint8_t bright);
        void blinkError(uint8_t red, uint8_t green, uint8_t blue, uint8_t pulses);
        void blinkLED(uint8_t red, uint8_t green, uint8_t blue, unsigned long blinkTime);
    };
